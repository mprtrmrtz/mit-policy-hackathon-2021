...
lapply(Vaccine_Hesitancy, class)
...
#(covid_Chronicdiseases_bystate_2018)
...
#(Hospital_Capacity_95_interval)

head(Hospital_Capacity_95_interval)
...
dim(hospital_capacity)
length(Hospital_Capacity_95_interval$state)
...
colnames(vaccine_hospital_info)
...
## PRB Senior Percent Visualization per County =================================================
...
print(nchar(senior_percent[6968,1]))

class(senior_percent$FIPS)
